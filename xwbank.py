...
model = Sequential()
model.add(Dense(32, activation='relu', input_dim=112))#  38 ,157//112
...
print(datax)
print(datay)
model.fit(datax, datay, epochs=10, batch_size=320)
...
with open('out01.csv', 'w') as f:
    ...
    for i in range(10000):
        outstring=str(data_cust[i][0])+','+str(round(int(result_list[i][0]),8))+'\n'
        f.write(outstring)
